...
class RuleEngineMapper:
    ...
    def join(self, params):
        ...
        params.job_dict[mapper_constants.BATCH_ID] = "{}{}{}".format(params.batch_id, params.step_number,
                                                                     params.step_name)
        ...
        if join_dict.get(Constants.JOIN_ACTION, '').strip() != "":
            write_logs(mapper_constants.INFO, "Executing Action : {}".format(join_dict.get(Constants.JOIN_ACTION, '')),
                       params)
